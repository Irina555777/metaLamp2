...
/***/ "./src/block/libs/reservation/reservation.js":
/*!***************************************************!*\
  !*** ./src/block/libs/reservation/reservation.js ***!
  \***************************************************/
/***/ (() => {
...
const totalSumUp = function () {
  const sumAll = parseInt(infoPrice[0].innerHTML) * parseInt(infoDaySum[0].innerHTML) - parseInt(discount[0].innerHTML) + parseInt(infoServiceFee[0].innerHTML) + parseInt(infoServiceFee[1].innerHTML);
...
/* harmony import */ var _block_libs_reservation_reservation_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./block/libs/reservation/reservation.js */ "./src/block/libs/reservation/reservation.js");
/* harmony import */ var _block_libs_reservation_reservation_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_block_libs_reservation_reservation_js__WEBPACK_IMPORTED_MODULE_4__);
